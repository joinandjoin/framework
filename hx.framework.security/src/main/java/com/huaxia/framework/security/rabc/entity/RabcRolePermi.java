...
/**
 * The persistent class for the rabc_role_permis database table.
 * 
 */
@Entity
...
public class RabcRolePermi implements Serializable {
	...
	@Column(name="permis_no")
	private BigInteger permisNo;
	...
	public BigInteger getPermisNo() {
		return this.permisNo;
	}

	public void setPermisNo(BigInteger permisNo) {
		this.permisNo = permisNo;
	}
